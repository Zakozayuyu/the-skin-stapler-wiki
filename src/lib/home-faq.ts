...
export const homeFaq: Record<Locale, Array<{ question: string; answer: string }>> = {
  en: [
    ...
    { question: 'What platforms is The Skin Stapler on?', answer: 'Windows PC only, through Steam and GOG. No PlayStation, Xbox, Switch, mobile, or macOS version is announced on the official pages.' },
    { question: 'Is The Skin Stapler multiplayer?', answer: 'No. It is a single-player story with several playable viewpoints, and no co-op or multiplayer mode is listed by the official stores.' },
    { question: 'How long is The Skin Stapler?', answer: 'It is an authored horror feature designed to be completed in one sitting. Published full runs take about three hours; exploration and achievement hunting can extend that.' },
  ...
  de: [
    ...
    { question: 'Für welche Plattformen gibt es The Skin Stapler?', answer: 'Offiziell nur für Windows PC über Steam und GOG. Eine PlayStation-, Xbox-, Switch-, Mobil- oder macOS-Version ist auf den offiziellen Seiten nicht angekündigt.' },
    ...
    { question: 'Wie lange dauert The Skin Stapler?', answer: 'Es ist eine kurze, erzählte Horrorgeschichte, die laut offizieller Beschreibung in einer Sitzung zu schaffen ist. Ausgewertete Komplettdurchläufe dauern rund drei Stunden.' },
  ...
  'pt-br': [
    ...
    { question: 'Em quais plataformas The Skin Stapler está disponível?', answer: 'Apenas Windows PC, pela Steam e pela GOG. Nenhuma versão para PlayStation, Xbox, Switch, celular ou macOS foi anunciada nas páginas oficiais.' },
    { question: 'The Skin Stapler tem multiplayer?', answer: 'Não. É uma história single-player com vários pontos de vista jogáveis; as lojas oficiais não listam modo cooperativo nem multiplayer.' },
    { question: 'Quanto tempo dura The Skin Stapler?', answer: 'É uma história de terror autoral, feita para ser concluída em uma sessão. Os vídeos de partidas completas publicados duram cerca de três horas; exploração e conquistas podem aumentar isso.' },
  ...
  es: [
    ...
    { question: '¿En qué plataformas está The Skin Stapler?', answer: 'Solo Windows PC, a través de Steam y GOG. Las páginas oficiales no anuncian versiones para PlayStation, Xbox, Switch, móvil ni macOS.' },
    { question: '¿The Skin Stapler tiene multijugador?', answer: 'No. Es una historia para un jugador con varios puntos de vista jugables; las tiendas oficiales no listan modo cooperativo ni multijugador.' },
    { question: '¿Cuánto dura The Skin Stapler?', answer: 'Es una historia de terror con guion cerrado, pensada para completarse en una sesión. Las partidas completas publicadas rondan las tres horas; la exploración y los logros pueden alargarla.' },
