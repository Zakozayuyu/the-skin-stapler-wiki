...
export const keywordArticles = {
  ...
  'the-skin-stapler-voice-actors': { keyword: 'the skin stapler voice cast', title: 'The Skin Stapler Voice Cast: Every Confirmed Role', description: 'The Skin Stapler voice cast includes the confirmed English performers for Dick Slater, Robbie Knox, Fefe, Hexy, Nurse Layna, Scaroline, Blair, and other roles.', category: 'Cast', summary: 'The cast-poster credits, confirmed role mappings, English audio, and earlier-list discrepancy.', Component: VoiceActors },
