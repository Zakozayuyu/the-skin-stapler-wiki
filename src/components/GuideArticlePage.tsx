...
const copy = {
  en: { title: 'Beginner Guide', description: 'Verified starting information for your first night in Carrion City. Unconfirmed controls, settings, and routes are marked as pending confirmation.', home: 'Home', guides: 'Guides', eyebrow: 'Start Here', spoiler: 'Spoiler-aware', demo: 'Try the Free Demo', demoTitle: 'Free Demo', demoText: 'The Skin Stapler Demo is available separately on Steam.' },
