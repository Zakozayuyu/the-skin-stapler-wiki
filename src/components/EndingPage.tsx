  ...
  return (
    ...
    >
      ...
      <aside className="card answer-box">
        ...
        <p>The Skin Stapler is Elias Crow, owner of the Flesh Pit barbecue restaurant. He targets Dick Slater because Slater killed his brother, Silus Kain. Elias captures Slater and Robbie Knox, Robbie is struck down, and Slater uses Robbie’s gun to kill Elias before abandoning Carrion City.</p>
      </aside>
      ...
      <p>Elias then carries out the personal part of his revenge by turning on Robbie. Robbie is struck down and tells Slater to use his gun. Slater gets the weapon, kills Elias, and ends the immediate threat from the Skin Stapler.</p>
      ...
      <p>Killing Elias closes the murder case, but it does not restore Slater’s faith in the city. After speaking to Robbie, he says he is finished trying to save Carrion City and plans to ride away. His final line condemns the city rather than celebrating the solved case.</p>
      <p>That choice gives the ending its bitter tone. Slater survives and defeats Elias, but loses his new partner and walks away from the job he had been doing. The ending resolves the killer’s identity and revenge motive while leaving Carrion City itself as a place Slater no longer believes he can fix.</p>
