...
const content = {
  privacy: {
    en: ['Privacy Policy', 'This independent fan site does not intentionally collect personal information through forms or user accounts. Hosting providers may process standard technical logs, and external services linked from this site apply their own privacy policies.', 'This site uses Google Analytics to measure visits and an Adsterra advertising placement served from effectivecpmnetwork.com. These providers may process technical and usage data and may use cookies or similar technologies under their own privacy policies. No newsletter service is configured in this project.'],
    de: ['Datenschutzerklärung', 'Diese unabhängige Fanseite sammelt nicht absichtlich personenbezogene Daten über Formulare oder Benutzerkonten. Hosting-Anbieter können übliche technische Protokolle verarbeiten; verlinkte externe Dienste haben eigene Datenschutzrichtlinien.', 'Diese Website nutzt Google Analytics zur Messung von Besuchen und eine Adsterra-Werbeplatzierung über effectivecpmnetwork.com. Diese Anbieter können technische und nutzungsbezogene Daten verarbeiten und nach ihren eigenen Datenschutzrichtlinien Cookies oder ähnliche Technologien verwenden. Ein Newsletter-Dienst ist nicht konfiguriert.'],
    'pt-br': ['Política de privacidade', 'Este site independente feito por fãs não coleta intencionalmente informações pessoais por formulários ou contas de usuário. Provedores de hospedagem podem processar registros técnicos padrão, e os serviços externos vinculados aplicam suas próprias políticas.', 'Este site usa o Google Analytics para medir visitas e um espaço publicitário da Adsterra servido por effectivecpmnetwork.com. Esses provedores podem processar dados técnicos e de uso e usar cookies ou tecnologias semelhantes conforme suas próprias políticas. Não há serviço de newsletter configurado.'],
    es: ['Política de privacidad', 'Este sitio independiente hecho por fans no recopila intencionadamente información personal mediante formularios o cuentas. Los proveedores de alojamiento pueden procesar registros técnicos estándar y los servicios externos enlazados aplican sus propias políticas.', 'Este sitio utiliza Google Analytics para medir las visitas y un espacio publicitario de Adsterra servido desde effectivecpmnetwork.com. Estos proveedores pueden tratar datos técnicos y de uso y utilizar cookies o tecnologías similares conforme a sus propias políticas. No hay ningún servicio de boletines configurado.']
  },
  terms: {
