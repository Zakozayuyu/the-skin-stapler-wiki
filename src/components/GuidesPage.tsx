...
export default function GuidesPage({ locale }: { locale: Locale }) {
  ...
  const primaryRoutes: Record<string, string> = { beginner: localizePath(locale, '/guides/beginner'), walkthrough: localizePath(locale, '/walkthrough'), achievements: localizePath(locale, '/ending') };
