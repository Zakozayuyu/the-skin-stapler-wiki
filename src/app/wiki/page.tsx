...
export const metadata: Metadata = {
  ...
  alternates: localizedAlternates('/wiki'),
  openGraph: { title: 'The Skin Stapler Wiki', description: 'Walkthroughs, endings, characters, cast, scenes, and release guides.', url: '/wiki', type: 'website', siteName: siteConfig.name, images: [openGraphImage('promo')] },
  twitter: { card: 'summary_large_image', title: 'The Skin Stapler Wiki', description: 'The complete Carrion City guide hub.', images: ['/images/official/carrion-city-promo.webp'] }
};
