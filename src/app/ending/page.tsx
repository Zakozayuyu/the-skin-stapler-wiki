...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/ending' },
  openGraph: { title: 'The Skin Stapler Ending Explained: Full Story', description: 'The killer’s identity, motive, Robbie’s fate, and Slater’s final choice.', url: '/ending', type: 'article' },
  twitter: { card: 'summary_large_image', title: 'The Skin Stapler Ending Explained: Full Story', description: 'The verified finale and details still awaiting confirmation.' }
};
